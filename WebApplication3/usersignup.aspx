                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>User-ID</label>
                                <div>
                                    <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="User-ID"></asp:TextBox>
                                </div>
                    ...
                    <div>
                        <div class="col-8 mx-auto">
                            <div class="form-group">
                                <asp:Button ID="Button1" runat="server" class="btn btn-success btn-block btn-lg" Text="Sign Up" OnClick="Button1_Click" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <span class="badge badge-pill badge-info">Your books Info</span>
                                </center>
                            </div>
                        </div>
